...
const VideoCarousel = () => {
  ...
  const [loadedData, setLoadedData] = useState<
    SetStateAction<HTMLVideoElement[]>
  >([]);
  ...
  ) => setLoadedData((prev: HTMLVideoElement[]) => [...prev, e.currentTarget]);
    ...
    switch (type) {
      case "video-end":
        setVideo((prevVideo) => ({
          ...prevVideo,
          isEnd: true,
          videoId: (i !== undefined ? i : prevVideo.videoId) + 1,
        }));
        break;
      case "video-last":
        setVideo((prevVideo) => ({
